async function Curriculo(){
    ...
    try{
        ...
        for (let index = 0; index < jsonComplete.length; index++) {
            ...
            const grauId = element.normalize("NFD").replace(/[\u0300-\u036f]/g, ""); // Normaliza para remover acentos
        
            // Verifica se o grau já foi adicionado
            if (!tipo_formacao.includes(grauId)) {
                tipo_formacao.push(grauId);
        
                // Criando título do grau
                ...
                // Adiciona os elementos ao container de formação
            ...
            // Agora adicionamos o curso ao grau correto
